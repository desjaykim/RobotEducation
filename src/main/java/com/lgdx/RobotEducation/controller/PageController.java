...
//        boolean isWeekday = day != DayOfWeek.SATURDAY && day != DayOfWeek.SUNDAY;
        ...
        boolean weekdayBusinessHours = true;
    ...
    public String counselPagelearn08() {
        return "counselor";
    }

    @GetMapping("/pageA")
    public String counselPagelearn09() { return "pageA"; }

    @GetMapping("/thinq_main_video")
    public String counselPagelearn10() { return "thinq_main_video"; }
    @GetMapping("/counsel05_video")
    public String counselPagelearn11() { return "counsel05_video"; }
    @GetMapping("/counsel07_video")
    public String counselPagelearn12() { return "counsel07_video"; }
    @GetMapping("/customerPage")
    public String counselPagelearn13() { return "customerPage"; }
    @GetMapping("/temp")
    public String counselPagelearn14() { return "temp"; }
