...
## 시연 영상
[![LG ThinQ '오똑이' 서비스](http://img.youtube.com/vi/JBl4miIxhew/0.jpg)](https://youtu.be/JBl4miIxhew?t=0s) 
...
- 신찬희
  - Keep : 야근을 감수하는 열정
  - Problem : 시간에 쫓김
  - Try : 프로젝트 계획을 모두의 의견을 모아서 더 현실적이고 촘촘하게 짜기 (WBS 작성)

- 정다진
  - Keep : 개인 역량에 따라 역할분담이 잘 되었으며, 개인 역할 이외에도 팀원들이 다같이 전체 큰 그림을 항상 그려나간 것
  - Problem : 시간 배분을 좀 더 효율적으로 했어야 했다
  - Try : 주기적인 회의로 wbs 작성하기

- 김정섭
  - Keep : 모든 선택지에서 팀원 모두가 함께 참여하고 결정하는 모습
  - Problem : 의사결정 과정에서 핵심 목적을 잊고 흔들리는 상황이 자주 있었음
  - Try : 프로젝트 전체 계획을 세세하게 설계해놓고 진행하기 + 유연한 사고로 피봇팅을 두려워하지 않기

- 이성찬
  - Keep : 개인역량에 따른 효율적인 업무분담과 모두가 참여적인 모습
  - Problem : 의사결정을 좀 더 데이터 기반으로 할 필요가 가끔 있었음
  - Try : 자신의 사고과정, 아이디어 등을 시각화자료와 같이 설명하기

- 이가현
  - keep : 팀 내에 긍정적인 에너지를 제공하며  발표 내용과 발표 방식에서도 창의적인 접근을 통해 청중의 이목을 집중시키며, 중요한 메시지를 효과적으로 전달하였습니다.
  - Problem : 과제 제출 기한을 맞추지 못한 경우, 미리 상황을 공유하고 팀원들에게 양해를 구함으로써 신뢰를 유지하고 문제를 함께 해결했습니다. 이를 통해 팀워크가 중요함을 깨달았고, 앞으로도 적극적인 소통을 통해 더 나은 결과를 만들 계획입니다.
  - Try : 칭찬과 벌점 제도를 통해 팀의 분위기를 유지하며 팀 활동을 팀원들과 함께 관리했습니다. 칭찬은 긍정적 동기부여를, 벌점은 책임감을 강화하여 팀 협력과 성과를 높이는 데 기여했습니다.
